...
class Track {
    ...
    public String toString() {
        ...
        return (getArtist() + ", " + getTitle() + ", " + formattedDuration(getDuration()));
    }
    ...
    private String formattedDuration(int totalSeconds) {
        ...
        if (seconde < 10){
            return (Integer.toString(minutes) + ":0"+  Integer.toString(seconde));
        }
        return (Integer.toString(minutes) + ":" + Integer.toString(seconde));
    }
}